    ...
    <>
      <main className="min-h-screen bg-[#f7f5f1] text-[#3d3834]">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-white/35 via-white/70 to-[#f7f5f1]" />
        ...
        {/* FILTERS */}
        <section className="mx-auto max-w-[1500px] px-8 py-16 md:px-12 lg:px-16">
          ...
          {filteredArticles.length === 0 && (
            <div className="py-24 text-center">
              <p
                style={futuraLight}
                className="text-[24px] lowercase tracking-[0.18em] text-[#6f625c]"
              >
